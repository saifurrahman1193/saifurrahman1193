...
### About Me
Software Engineer with **6+** years of experience in web app development. Skilled in Laravel, REST API, Node.js, React, Vue, Oracle Database 11g, MySQL, MongoDB, Socket.io, and Docker. Goal-oriented, hardworking, and a proven key team player by solving problems effectively. Currently pursuing a master's in Data Science.
